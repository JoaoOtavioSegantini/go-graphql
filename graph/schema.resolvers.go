...
import (
	...
	"github.com/joaootav/gqlgen-todos/graph/generated"
	"github.com/joaootav/gqlgen-todos/graph/model"
)

func generateId() *big.Int {
	value, err := rand.Int(rand.Reader, big.NewInt(1000000000000000000))
	if err != nil {
